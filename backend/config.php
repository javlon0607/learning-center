...
function initDB() {
    ...
    // Migration 3: Add missing keys for Header, Settings, Students, Teachers, Expenses, Collections
    try {
        $stmt = getDB()->prepare("INSERT INTO translations (lang, key, value) VALUES (?, ?, ?) ON CONFLICT DO NOTHING");
        $newKeys3 = [
            // Header
            ['en','header.search_placeholder','Search students, groups, teachers...'], ['uz','header.search_placeholder',"O'quvchi, guruh, o'qituvchi izlash..."],
            ['en','header.class_timetable','Class Timetable'], ['uz','header.class_timetable','Dars jadvali'],
            ['en','header.notifications','Notifications'], ['uz','header.notifications','Bildirishnomalar'],
            ['en','header.mark_all_read','Mark all read'], ['uz','header.mark_all_read',"Barchasini o'qilgan deb belgilash"],
            ['en','header.birthdays_section',"Today's Birthdays"], ['uz','header.birthdays_section',"Bugungi tug'ilgan kunlar"],
            ['en','header.turns','Turns'], ['uz','header.turns',''],
            ['en','header.today_bday','today'], ['uz','header.today_bday',"yoshga to'ldi"],
            ['en','header.no_notifications','No notifications'], ['uz','header.no_notifications',"Bildirishnomalar yo'q"],
            ['en','header.profile_settings','Profile Settings'], ['uz','header.profile_settings','Profil sozlamalari'],
            ['en','header.sign_out','Sign out'], ['uz','header.sign_out','Chiqish'],
            // Settings - toast messages
            ['en','settings.toast_save_error','Failed to save settings'], ['uz','settings.toast_save_error','Sozlamalarni saqlashda xatolik'],
            ['en','settings.toast_profile_updated','Profile updated'], ['uz','settings.toast_profile_updated','Profil yangilandi'],
            ['en','settings.toast_profile_error','Failed to update profile'], ['uz','settings.toast_profile_error','Profilni yangilashda xatolik'],
            ['en','settings.toast_password_changed','Password changed successfully'], ['uz','settings.toast_password_changed',"Parol muvaffaqiyatli o'zgartirildi"],
            ['en','settings.toast_password_error','Failed to change password'], ['uz','settings.toast_password_error',"Parolni o'zgartirishda xatolik"],
            ['en','settings.toast_org_saved','Organization settings saved'], ['uz','settings.toast_org_saved','Tashkilot sozlamalari saqlandi'],
            ['en','settings.toast_notifications_saved','Notification preferences saved'], ['uz','settings.toast_notifications_saved','Bildirishnoma sozlamalari saqlandi'],
            ['en','settings.toast_check_complete','Check complete'], ['uz','settings.toast_check_complete','Tekshirish yakunlandi'],
            ['en','settings.toast_check_failed','Check failed'], ['uz','settings.toast_check_failed','Tekshirish amalga oshmadi'],
            ['en','settings.toast_security_saved','Security settings saved'], ['uz','settings.toast_security_saved','Xavfsizlik sozlamalari saqlandi'],
            ['en','settings.toast_name_required','Name is required'], ['uz','settings.toast_name_required','Ism majburiy'],
            ['en','settings.toast_current_password_required','Current password is required'], ['uz','settings.toast_current_password_required','Joriy parol majburiy'],
            ['en','settings.toast_new_password_required','New password is required'], ['uz','settings.toast_new_password_required','Yangi parol majburiy'],
            ['en','settings.toast_password_too_short','Password must be at least 6 characters'], ['uz','settings.toast_password_too_short',"Parol kamida 6 ta belgidan iborat bo'lishi kerak"],
            ['en','settings.toast_passwords_mismatch','Passwords do not match'], ['uz','settings.toast_passwords_mismatch','Parollar mos kelmaydi'],
            ['en','settings.toast_exporting_desc','Download will start shortly'], ['uz','settings.toast_exporting_desc','Yuklab olish tez boshlanadi'],
            // Students
            ['en','students.toast_created','Student created successfully'], ['uz','students.toast_created',"O'quvchi muvaffaqiyatli yaratildi"],
            ['en','students.toast_updated','Student updated successfully'], ['uz','students.toast_updated',"O'quvchi muvaffaqiyatli yangilandi"],
            ['en','students.toast_deleted','Student deleted successfully'], ['uz','students.toast_deleted',"O'quvchi muvaffaqiyatli o'chirildi"],
            ['en','students.toast_delete_error','Cannot delete student'], ['uz','students.toast_delete_error',"O'quvchini o'chirib bo'lmaydi"],
            ['en','students.col_parent','Parent/Guardian'], ['uz','students.col_parent','Ota-ona / Vasiy'],
            ['en','students.paid','Paid'], ['uz','students.paid',"To'langan"],
            ['en','students.source_walkin','Walk-in'], ['uz','students.source_walkin','Tasodifiy'],
            ['en','students.empty_title','No students found'], ['uz','students.empty_title',"O'quvchilar topilmadi"],
            ['en','students.empty_filter','Try adjusting your search or filter criteria'], ['uz','students.empty_filter',"Qidiruv yoki filtr mezonlarini o'zgartiring"],
            ['en','students.empty_first','Get started by adding your first student'], ['uz','students.empty_first',"Birinchi o'quvchingizni qo'shish bilan boshlang"],
            ['en','students.dialog_delete_desc','Are you sure you want to delete'], ['uz','students.dialog_delete_desc',"O'chirishni tasdiqlaysizmi"],
            ['en','students.tooltip_expected','Expected'], ['uz','students.tooltip_expected','Kutilgan'],
            ['en','students.tooltip_paid','Paid'], ['uz','students.tooltip_paid',"To'langan"],
            ['en','students.tooltip_remaining','Remaining'], ['uz','students.tooltip_remaining','Qoldiq'],
            // Teachers
            ['en','teachers.toast_created','Teacher created successfully'], ['uz','teachers.toast_created',"O'qituvchi muvaffaqiyatli yaratildi"],
            ['en','teachers.toast_updated','Teacher updated successfully'], ['uz','teachers.toast_updated',"O'qituvchi muvaffaqiyatli yangilandi"],
            ['en','teachers.toast_deleted','Teacher deleted successfully'], ['uz','teachers.toast_deleted',"O'qituvchi muvaffaqiyatli o'chirildi"],
            ['en','teachers.toast_delete_error','Cannot delete teacher'], ['uz','teachers.toast_delete_error',"O'qituvchini o'chirib bo'lmaydi"],
            ['en','teachers.toast_select_user','Select a user with teacher role'], ['uz','teachers.toast_select_user',"O'qituvchi roliga ega foydalanuvchini tanlang"],
            ['en','teachers.form_select_user_label','Select user (teacher role, not yet a teacher) *'], ['uz','teachers.form_select_user_label',"Foydalanuvchi tanlang (o'qituvchi roli, hali o'qituvchi emas) *"],
            ['en','teachers.form_select_user_placeholder','Select user...'], ['uz','teachers.form_select_user_placeholder','Foydalanuvchi tanlang...'],
            ['en','teachers.form_no_users','No users with teacher role that are not yet linked to a teacher. Add a user with teacher role in Settings \u2192 Users.'], ['uz','teachers.form_no_users',"O'qituvchi roliga ega va hali o'qituvchiga bog'lanmagan foydalanuvchilar yo'q."],
            ['en','teachers.form_salary_percentage','Percentage per student (%)'], ['uz','teachers.form_salary_percentage',"O'quvchi boshiga foiz (%)"],
            ['en','teachers.form_salary_amount','Salary Amount'], ['uz','teachers.form_salary_amount','Maosh miqdori'],
            ['en','teachers.form_first_name','First Name *'], ['uz','teachers.form_first_name','Ism *'],
            ['en','teachers.form_last_name','Last Name *'], ['uz','teachers.form_last_name','Familiya *'],
            ['en','teachers.form_phone','Phone'], ['uz','teachers.form_phone','Telefon'],
            ['en','teachers.form_email','Email'], ['uz','teachers.form_email','Email'],
            ['en','teachers.dialog_delete_title','Delete Teacher'], ['uz','teachers.dialog_delete_title',"O'qituvchini o'chirish"],
            ['en','teachers.dialog_delete_desc','Are you sure you want to delete'], ['uz','teachers.dialog_delete_desc',"O'chirishni tasdiqlaysizmi"],
            ['en','teachers.status_active','Active'], ['uz','teachers.status_active','Faol'],
            ['en','teachers.status_inactive','Inactive'], ['uz','teachers.status_inactive','Faol emas'],
            // Expenses - keys matching frontend t() calls
            ['en','expenses.search','Search expenses...'], ['uz','expenses.search','Xarajatlarni qidirish...'],
            ['en','expenses.all_categories','All categories'], ['uz','expenses.all_categories','Barcha kategoriyalar'],
            ['en','expenses.all_months','All months'], ['uz','expenses.all_months','Barcha oylar'],
            ['en','expenses.no_data','No expenses found'], ['uz','expenses.no_data','Xarajatlar topilmadi'],
            ['en','expenses.dialog_add','Add Expense'], ['uz','expenses.dialog_add',"Xarajat qo'shish"],
            ['en','expenses.form_select_category','Select category'], ['uz','expenses.form_select_category','Kategoriya tanlang'],
            ['en','expenses.form_select_teacher','Select teacher'], ['uz','expenses.form_select_teacher',"O'qituvchi tanlang"],
            ['en','expenses.calculating_salary','Calculating salary...'], ['uz','expenses.calculating_salary','Maosh hisoblanmoqda...'],
            ['en','expenses.salary_per_student','Per-Student Salary Calculation'], ['uz','expenses.salary_per_student',"O'quvchi boshiga maosh hisoblash"],
            ['en','expenses.salary_collected','Collected payments'], ['uz','expenses.salary_collected',"Yig'ilgan to'lovlar"],
            ['en','expenses.salary_teacher_rate','Teacher rate'], ['uz','expenses.salary_teacher_rate',"O'qituvchi foizi"],
            ['en','expenses.salary_calculated_base','Calculated base'], ['uz','expenses.salary_calculated_base','Hisoblangan asosiy miqdor'],
            ['en','expenses.salary_fixed','Fixed salary'], ['uz','expenses.salary_fixed','Belgilangan maosh'],
            ['en','expenses.toast_salary_zero','Salary total must be greater than zero'], ['uz','expenses.toast_salary_zero',"Maosh jami noldan katta bo'lishi kerak"],
            ['en','expenses.toast_select_teacher','Please select a teacher'], ['uz','expenses.toast_select_teacher',"O'qituvchi tanlang"],
            ['en','expenses.toast_invalid_amount','Enter a valid amount'], ['uz','expenses.toast_invalid_amount',"To'g'ri miqdor kiriting"],
            ['en','expenses.toast_salary_recorded','Salary expense recorded successfully'], ['uz','expenses.toast_salary_recorded','Maosh xarajati muvaffaqiyatli qayd etildi'],
            ['en','expenses.toast_salary_error','Failed to create salary expense'], ['uz','expenses.toast_salary_error','Maosh xarajatini yaratishda xatolik'],
            ['en','expenses.toast_recorded','Expense recorded successfully'], ['uz','expenses.toast_recorded','Xarajat muvaffaqiyatli qayd etildi'],
            ['en','expenses.toast_deleted','Expense deleted successfully'], ['uz','expenses.toast_deleted',"Xarajat muvaffaqiyatli o'chirildi"],
            ['en','expenses.toast_delete_error','Cannot delete expense'], ['uz','expenses.toast_delete_error',"Xarajatni o'chirib bo'lmaydi"],
            ['en','expenses.confirm_delete','Are you sure you want to delete this expense? This action marks it as deleted.'], ['uz','expenses.confirm_delete',"Bu xarajatni o'chirishni tasdiqlaysizmi?"],
            ['en','expenses.btn_add','Add Expense'], ['uz','expenses.btn_add',"Xarajat qo'shish"],
            ['en','expenses.form_description_placeholder','Enter expense details...'], ['uz','expenses.form_description_placeholder','Xarajat tafsilotlarini kiriting...'],
            // Collections - keys matching frontend t() calls
            ['en','collections.search','Search by name or phone...'], ['uz','collections.search',"Ism yoki telefon bo'yicha qidirish..."],
            ['en','collections.stat_debtors','Students with Debt'], ['uz','collections.stat_debtors',"Qarzdor o'quvchilar"],
            ['en','collections.no_match','No matching students found.'], ['uz','collections.no_match',"Mos o'quvchilar topilmadi."],
            ['en','collections.no_debtors','No students with outstanding debt this month.'], ['uz','collections.no_debtors',"Bu oy qarzdor o'quvchilar yo'q."],
            ['en','collections.call_notes_placeholder','What was discussed during the call?'], ['uz','collections.call_notes_placeholder',"Qo'ng'iroq davomida nima muhokama qilindi?"],
            ['en','collections.detail_call_history','Call History'], ['uz','collections.detail_call_history',"Qo'ng'iroqlar tarixi"],
            ['en','collections.no_calls','No calls recorded yet.'], ['uz','collections.no_calls',"Hali qo'ng'iroqlar qayd etilmagan."],
            ['en','collections.toast_log_error','Failed to log call'], ['uz','collections.toast_log_error',"Qo'ng'iroqni qayd etishda xatolik"],
            ['en','collections.detail_expected','Expected'], ['uz','collections.detail_expected','Kutilgan'],
            ['en','collections.detail_paid','Paid'], ['uz','collections.detail_paid',"To'langan"],
            ['en','collections.detail_debt','Debt'], ['uz','collections.detail_debt','Qarzdorlik'],
            ['en','collections.detail_contact','Contact'], ['uz','collections.detail_contact','Aloqa'],
            ['en','collections.detail_parent','Parent'], ['uz','collections.detail_parent','Ota-ona'],
            ['en','collections.detail_groups','Groups'], ['uz','collections.detail_groups','Guruhlar'],
            ['en','collections.btn_log_call','Log New Call'], ['uz','collections.btn_log_call',"Yangi qo'ng'iroq qayd etish"],
            ['en','collections.dialog_log_call','Log Call'], ['uz','collections.dialog_log_call',"Qo'ng'iroqni qayd etish"],
        ];
        foreach ($newKeys3 as [$lang, $key, $value]) {
            $stmt->execute([$lang, $key, $value]);
        }
    } catch (PDOException $e) { /* ignore */ }
